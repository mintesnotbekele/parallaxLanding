...
export default function HeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative mx-26 max-h-screen text-white flex items-center overflow-hidden py-20"
    >
      ...
      <motion.div
        className="relative max-w-7xl text-left z-20"
      ...
      >
       ...
       <button
  className="mt-8 px-6 py-3 rounded-full font-medium text-white relative overflow-hidden transition-all duration-300"
>
